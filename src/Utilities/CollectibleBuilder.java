...
public class CollectibleBuilder {
	...
	public static Map<String, CollectibleData> myStringCollectibles;
	public static void init(){
    	// General file-reading stuff, nothing to see here
		collectibleData = new String[100];
		...
		myStringCollectibles = new HashMap<String, CollectibleData>();
		for(int i=0; i<1; i++){
			CollectibleData c = new CollectibleData(i);
			myCollectibles.put(i, c);
			myStringCollectibles.put(myCollectibles.get(i).getName(), myCollectibles.get(i));
		}
	}
	public static CollectibleData getCollectibleObject(int i){
		return myCollectibles.get(i);
	}
	public static CollectibleData getCollectibleObject(String s){
		return myStringCollectibles.get(s);
	}
